...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      '}',
      '',
      '/* native select popup: keep option text readable in both themes */',
      'body[data-dsh-claude] select {',
      '  color-scheme: dark;',
      '}',
      '',
      'body[data-dsh-claude]:not([data-ds-dark-theme]) select {',
      '  color-scheme: light;',
      '}',
      '',
      'body[data-dsh-claude] select option {',
      '  background-color: #262624;',
      '  color: #faf9f5;',
      '}',
      '',
      'body[data-dsh-claude]:not([data-ds-dark-theme]) select option {',
    ...
    /**
     * One labeled select for the font mode. The selected mode is stored in
     * the slot store so the row re-renders after a change.
     */
    function FontModeRow({ t, setMode, useStore }) {
      ...
      return react_jsx_runtime.jsx('div', {
        style: styles.group,
        children: [
          react_jsx_runtime.jsx('div', { style: styles.title, children: t('font.title') }),
          react_jsx_runtime.jsx('div', {
            style: styles.row,
            children: [
              react_jsx_runtime.jsx('span', { style: styles.label, children: t('font.label') }),
              react_jsx_runtime.jsx('select', {
                value: mode,
                style: styles.select,
                onChange: (event) => setMode(event.target.value),
                children: FONT_MODES.map((id) =>
                  react_jsx_runtime.jsx('option', { value: id, children: t('font.' + id) }, id)
                )
              })
            ]
          }),
          react_jsx_runtime.jsx('div', { style: styles.hint, children: t('font.hint') })
        ]
      })
    }
