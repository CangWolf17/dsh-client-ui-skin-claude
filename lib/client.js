...
window.__ModuleLoader__.load({
  id: '@dsh-external/dsh-client-ui-skin-claude',
  factory: (require) => {
    'use strict'
    var module = { exports: {} }
    ...
    var CSS = [
      ...
      '}',
      '',
      '/* Claude buttons: 8px radius, clay primary */',
      'body[data-dsh-claude] button {',
      '  border-radius: 8px;',
      '}',
      '',
      'body[data-dsh-claude] button[class*="newSession"],',
      'body[data-dsh-claude] [data-slot="sidebar.settings"] button {',
      '  border-radius: 8px;',
      '  background: #d97757;',
      '  color: #ffffff;',
      '}',
      '',
      '/* Claude inputs: rounded, clay focus border */',
      'body[data-dsh-claude] :is(input, textarea, select, [contenteditable="true"]) {',
      '  border-radius: 8px;',
      '}',
      '',
      'body[data-dsh-claude] :is(input, textarea, select, [contenteditable="true"]):focus {',
      '  border-color: rgba(217, 119, 87, 0.7);',
      '  box-shadow: 0 0 0 2px rgba(217, 119, 87, 0.18);',
      '}',
      '',
      '/* Claude badges: full pill */',
      'body[data-dsh-claude] :is([class*="badge"], [class*="Badge"], [class*="tag"], [data-state="ongoing"]) {',
      '  border-radius: 9999px;',
      '}',
      '',
      '/* Claude cards: 12px radius, hairline border */',
      'body[data-dsh-claude] :is([class*="card"], [class*="Card"], [class*="panel"]) {',
      '  border-radius: 12px;',
      '}',
      '',
      '/* Claude tabs: active = raised surface */',
      'body[data-dsh-claude] [role="tab"][aria-selected="true"],',
      'body[data-dsh-claude] [class*="tabActive"] {',
      '  border-radius: 8px;',
      ...
      '}',
      '',
      '/* Claude shadows: layered, subtle */',
      'body[data-dsh-claude] [data-composer-card] {',
      '  box-shadow: 0 1px 2px rgba(0, 0, 0, 0.3), 0 8px 24px rgba(0, 0, 0, 0.18);',
      '}',
      '',
      '/* Claude sidebar items: hover raises subtly */',
      'body[data-dsh-claude] [role="treeitem"]:hover,',
      'body[data-dsh-claude] [role="listitem"]:hover {',
      '  border-radius: 8px;',
      '}',
      '',
      'body[data-dsh-claude] {',
      ...
      '  background: #262624;',
      '  box-shadow: 0 18px 54px rgba(0, 0, 0, 0.5), 0 2px 8px rgba(0, 0, 0, 0.3);',
      '}',
      '',
      ...
      '}',
      '',
      'body[data-dsh-claude]:not([data-ds-dark-theme]) [data-composer-card] {',
      '  background: #ffffff;',
      '  border-color: #e8e6dc;',
      '  box-shadow: 0 18px 54px rgba(0, 0, 0, 0.08), 0 2px 8px rgba(0, 0, 0, 0.05);',
      '}',
      '',
      ...
      '}',
      '',
      '/* light scrollbar/selection/tab adjustments */',
      'body[data-dsh-claude]:not([data-ds-dark-theme]) * {',
      ...
      '}',
      '',
      'body[data-dsh-claude]:not([data-ds-dark-theme]) [role="tab"][aria-selected="true"],',
      'body[data-dsh-claude]:not([data-ds-dark-theme]) [class*="tabActive"] {',
      '  background: #ffffff;',
      '}',
      '',
      'body[data-dsh-claude]:not([data-ds-dark-theme]) [data-composer-card] {',
